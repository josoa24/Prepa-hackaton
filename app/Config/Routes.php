...
$routes->get('/participateEmail', 'ColaborationController::participateEmail', ['filter' => 'auth']);
$routes->post('/participateEmail', 'ColaborationController::participateEmail', ['filter' => 'auth']);
